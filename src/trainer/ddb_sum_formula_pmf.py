...
class SumFormulaScalarPriorPMFDDBTrainer(PMFDDBTrainer):
    def __init__(
        self,
        ...
        super(SumFormulaScalarPriorPMFDDBTrainer, self).__init__(
    ...
    def update_molecule_data_for_prior_prediction(
        ...
        data.update(
            {"idx": torch.tensor([idx]), "embedding": data["sum_formula_embedding"]}
        )
        return data
...
class SumFormulaPriorPMFDDBTrainer(SumFormulaScalarPriorPMFDDBTrainer):
    def __init__(
        self,
        args: argparse.Namespace,
        model: torch.nn.Module,
        ...
        super(SumFormulaPriorPMFDDBTrainer, self).__init__(
            args, model, dataloaders, loss
        )
